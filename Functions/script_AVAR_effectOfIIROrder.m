%%%%%%%%%%%%%%%%%%%%%% script_AVAR_effectOfIIROrder.m %%%%%%%%%%%%%%%%%%%%%
%% Purpose:
%   The purpose of this script is to demonstrate the effect of IIR
%   filter order on AVAR of the filter output.
%
...
list_iir_filter_order = [(2:5:30), (35:15:100)];
number_of_IIR_filters = numel(list_iir_filter_order);
...
legend_cell{1} = 'In';
for index_order = 1:number_of_IIR_filters
    iir_filter_order = list_iir_filter_order(index_order);
    ...
    legend_cell{index_order+1} = ['$M =$ ' num2str(iir_filter_order)];
