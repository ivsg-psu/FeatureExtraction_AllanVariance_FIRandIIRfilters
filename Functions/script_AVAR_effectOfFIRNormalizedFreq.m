%%%%%%%%%%%%%%%%% script_AVAR_effectOfFIRNormalizedFreq.m %%%%%%%%%%%%%%%%%
%% Purpose:
%   The purpose of this script is to demonstrate the effect of FIR's
...
number_of_FIR_filters              = numel(list_normalized_cutoff_frequencies);
...
legend_cell{1} = 'In';
for index_freq = 1:number_of_FIR_filters
